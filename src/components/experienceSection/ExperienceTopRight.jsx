  ...
  return (
    <div className="xl:w-[25%] lg:w-[30%] border border-lightBrown p-4 rounded-xl">
      <p className="text-lg text-center text-lightGrey">
        ...
        solutions. <br />
        My experience spans working on diverse projects, from static website to dynamic and responsive
        websites to{" "}
        <span className="font-bold text-white">complex Software development</span>,
